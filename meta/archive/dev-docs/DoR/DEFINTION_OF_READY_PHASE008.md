...
- [x] Testy sign-off Phase 007 przeszly lokalnie:
  - [x] `pnpm -C product/packages/shared test`
  - [x] `pnpm -C product/packages/shared typecheck`
  - [x] `pnpm -C product/apps/consumer-mobile typecheck`
- [x] Regression gate US2 jest zielony po zmianach US5:
  - [x] `pnpm -C product/apps/web test:generate-qr`
  - [x] `pnpm -C product/apps/web test:e2e`
...
- [x] Srodowiska uruchomieniowe sa gotowe:
  - [x] `product/apps/consumer-mobile` startuje lokalnie
  - [x] `product/apps/web` startuje lokalnie
...
- [x] Istnieja komponenty i flow do rozszerzenia:
  - [x] `product/apps/web/app/dashboard/coffees/[id]/batches/[batchId]/page.tsx`
  - [x] `product/apps/web/app/dashboard/coffees/page.tsx`
  - [x] `product/packages/shared/src/services/tastingService.ts`
