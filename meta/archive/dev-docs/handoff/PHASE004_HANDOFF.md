...
- Blokery pre-Go zostały domknięte:
  - Smoke `product/supabase/seed.sql` + runtime edge functions (US1): PASS.
...
- `product/supabase/functions/generate_qr/index.ts`
  - auth token check,
...
- Auth:
  - `product/apps/web/app/(auth)/login/page.tsx`
  - `product/apps/web/app/(auth)/register/page.tsx`
  - `product/apps/web/app/(auth)/pending/page.tsx`
- Dashboard / coffee-batch:
  - `product/apps/web/app/dashboard/coffees/page.tsx`
  - `product/apps/web/app/dashboard/coffees/new/page.tsx`
  - `product/apps/web/app/dashboard/coffees/[id]/page.tsx`
  - `product/apps/web/app/dashboard/coffees/[id]/batches/new/page.tsx`
  - `product/apps/web/app/dashboard/coffees/[id]/batches/[batchId]/page.tsx`
  - `product/apps/web/app/dashboard/coffees/[id]/batches/[batchId]/QRDownloadButton.tsx`
- Hash resolve:
  - `product/apps/web/app/q/[hash]/page.tsx`
- Entry:
  - `product/apps/web/app/page.tsx` (linki do flow)
...
- `funcup-src-docs/04-tasks/13-tasks-002-qr-coffee-platform-88-tasks.md`
  - doprecyzowane ścieżki web dla Phase 4: `product/apps/web/app/...`.

## 3) Krytyczne decyzje techniczne (ważne dla kontynuacji)

- Canonical path dla web tasków Phase 4: `product/apps/web/app/...` (Next App Router).
...
- Dla pre-commit builda usunięto build-time throw na brak env w:
  - `product/apps/web/src/lib/product/supabase/browserClient.ts`
  - `product/apps/web/src/lib/product/supabase/serverClient.ts`
...
bez zmiany kontraktu API i bez regresji ścieżek product/apps/web/app/... .
