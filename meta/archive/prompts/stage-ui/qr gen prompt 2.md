...
* implementacja:
  ...
  * lokalizacja: `product/apps/web/app/api/qr/route.ts`
* runtime:
...
* ❓ Next.js vs osobny serwis vs VPS
  → **Next.js Route Handler (product/apps/web)**
...
### 12. Folder `product/supabase/functions/coffee`
...
* `product/packages/shared` opcjonalne, nie wymagane
...
→ **Next.js Route Handler (`product/apps/web/app/api/qr`)**
