...
* `product/apps/web` → Next.js (App Router) → roaster-app (WEB ONLY)
* `product/apps/consumer-mobile` → Expo → consumer-app (MOBILE ONLY)

UI is platform-specific:
- product/apps/web → web UI (Next.js)
- product/apps/consumer-mobile → mobile UI (React Native)
...
```
product/apps/web/src/types/roasterCoffeeTag.ts
```
