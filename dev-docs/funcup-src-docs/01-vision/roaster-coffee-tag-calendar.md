...
8. Na wszystkich stronach w przeglądarce użyj stylów spójnych z `apps/web/src/theme/authScreenStyles.ts` (tokeny jak consumer / auth).
9. Dla web: struktura tras w `apps/web/app/` (Next.js App Router); roaster tag: np. `/tag`.
